        ...
        <div className="mb-1 w-full">
          <div className="mb-4">
            <Breadcrumb className="mb-4">
              ...
              <Breadcrumb.Item>Intercom</Breadcrumb.Item>
            </Breadcrumb>
            <div className="flex items-center">
              <SiIntercom className="mr-2 text-xl" />
              <h1 className="text-xl font-semibold text-gray-900 dark:text-white sm:text-2xl">
                Intercom
              </h1>
            </div>
            <Text>
              View your active connections and configure the Intercom connector
      ...
      <Tabs.Group>
        <Tabs.Item active={true} title="Active Connections">
          <div className="block items-center justify-between border-b border-gray-200 bg-white p-4 dark:border-gray-700 dark:bg-gray-800 sm:flex">
            <div className="mb-1 w-full">
              <div className="mb-4">
                <h2 className="mb-2 text-sm font-semibold text-gray-900 dark:text-white sm:text-lg">
                  Active connections
                </h2>
                <ConnectionsTable
    ...
    <>
      ...
      <Modal onClose={() => setOpen(false)} show={isOpen}>
        <Modal.Header className="border-b border-gray-200 !p-6 dark:border-gray-700">
          <strong>Custom Intercom Credentials</strong>
        </Modal.Header>
        <Modal.Body>
          <form>
            <div className="lg:col-span-2">
              <div>
                ...
                <TextInput
                  ...
                  placeholder="Intercom OAuth client ID"
                  className="mt-1"
                />
              </div>
              <div>
                ...
                <TextInput
                  ...
                  placeholder="Intercom OAuth client secret"
                  className="mt-1"
                />
              </div>
              <div>
                ...
                <TextInput
                  ...
                  placeholder="Intercom authorization URL"
                  className="mt-1"
                />
              </div>
            </div>
...
export default IntercomConnectorPage;
