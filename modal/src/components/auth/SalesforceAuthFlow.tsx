...
const SalesforceAuthFlow: React.FC = () => {
  ...
  const handleMessage = useCallback((event: MessageEvent) => {
    ...
    if (data && data.psychic_link &&  data.code && data.authorized_url && !authCodeHandled.current) {
      authCodeHandled.current = true
      console.log(data)
      setAuthCode(data.authorized_url)
...
export default SalesforceAuthFlow;
